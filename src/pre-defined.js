...
const AA_INSTRUCTORS_ITEMS = [
  '3. Please choose the seminar instructor in AA Program who you would like to work with (1st option).',
  '4. Please choose the seminar instructor in AA Program who you would like to work with (2nd option).',
];
const BB_INSTRUCTORS_ITEMS = [
  '3. Please choose the seminar instructor in BB Program who you would like to work with.',
];
const CC_INSTRUCTORS_ITEMS = [
  '3. Please choose the seminar instructor in CC Program who you would like to work with.',
];

//Sheet Names
const COURSES_SHEET_NAME = 'course-lineup';
const INSTRUCTORS_SHEET_NAME = 'instructor-lineup';
